...
public class WeiXinController extends Controller implements IConst {
	...
	public static String wxAppId = "wxb8ad1d1e70a70";
	public static String wxMerchantId = "13020001";
	public static String wxMerchantApiKey = "28657b8e7aefd6347faab9d9eb67a";
	public static String wxSecretId = "6e34832052c9d794de90810a61684";
	public static String wxAesKey = "9wB02qlkZl4gFYB7gYGvrQCesXfw8djYCjjxvzRq";
	public static String wxTokenStr = "ManianXiWeb";
	public static String lang = "zh_CN"; // 语言
	public static String getPrepayUrl = "https://api.mch.weixin.qq.com/pay/unifiedorder";
	public static String doPayUrl = "http://www.77wm.com.cn/wxpay/pay/go";
	public static String notifyUrl = "http://www.77wm.com.cn/wxpay/pay/notify";
...
//        return ok(bargain4friends.render(aid.toString()));
	...
	public static Result getPayNotify() {
		...
		if (buyer == null || StrUtil.isNull(openid) || !openid.equals(buyer.wxOpenId)) {
			...
			play.Logger.info(buyer.nickname + " 用户积分 + " + amount.toString());
...
//		OrderModel order = OrderModel.find.where().eq("orderNo", "100100100").findUnique();
		try {
//			// 给管理员推送下单信息
//			// String adminMessageText = "";
//			// String adminid = "oJj7gvyIHkoC0nfGI2mmss9dzZRA";
//			StringBuffer buffer = new StringBuffer();
//			buffer.append("珠海新订单到达！").append("\n\n");
...
//				buffer.append(order.buyer.nickname).append("\n\n");
//			} else {
...
//				buffer.append(order.orderNo).append("\n");
//			}
//			buffer.append("\n");
...
//			msg = buffer.toString();
	...
	public static void sendOrderMsgToWxUser(String openId, OrderModel order) {
		...
		try {
			...
			StoreModel store = StoreModel.find.byId(order.storeId);
			buffer.append(store.area.toUpperCase()).append("\n");

			buffer.append("订单号为：").append("\n");
			buffer.append(order.orderNo.toUpperCase()).append("\n");
			buffer.append("下单时间：").append("\n");
			buffer.append(order.createdAtStr).append("\n");
			if (StrUtil.isNotNull(order.payTime)) {
			...
			if (order.orderProducts.size() > 0) {
				List<Integer> quantityList = StrUtil.getIntegerListFromSplitStr(order.quantity);
				for (int i = 0; i < order.orderProducts.size(); i++) {
					buffer.append(order.orderProducts.get(i).name + " " + quantityList.get(i) + " × "
							+ order.orderProducts.get(i).price).append("\n");
				}
			} else {
				buffer.append("订单无货品，请在后台查看！ 订单号为： ").append("\n");
				buffer.append(order.orderNo).append("\n");
	...
	public static Result addMenu() {
		...
		button1_1.setName("吃虾秘籍");
		button1_1.setUrl("http://mp.weixin.qq.com/s?__biz=MzIxOTE0NDIzMA==&mid=404581154&idx=1&sn=d099bdc70e3cb222b5cec0eef518b04d#rd");

		WxMenu.WxMenuButton button1_2 = new WxMenu.WxMenuButton();
		button1_2.setType("view");
		button1_2.setName("DIY小龙虾");
		button1_2.setUrl("http://mp.weixin.qq.com/s?__biz=MzIxOTE0NDIzMA==&mid=405323220&idx=1&sn=3226ed3bb12389af653f72ac7d87dd72#rd");

		WxMenu.WxMenuButton button1_3 = new WxMenu.WxMenuButton();
		button1_3.setType("view");
		button1_3.setName("你懂虾吗");
		button1_3.setUrl("http://mp.weixin.qq.com/s?__biz=MzIxOTE0NDIzMA==&mid=405406844&idx=1&sn=4b0feb1f3a170d288985bbcd17bac6f6#rd");

		WxMenu.WxMenuButton button1_4 = new WxMenu.WxMenuButton();
		button1_4.setType("view");
		button1_4.setName("吃货福利");
		button1_4.setUrl("http://mp.weixin.qq.com/s?__biz=MzIxOTE0NDIzMA==&mid=405159419&idx=1&sn=0e184a5381021502de1a5b4ef0f13be4#rd");

		WxMenu.WxMenuButton button1_5 = new WxMenu.WxMenuButton();
        button1_5.setType("view");
        button1_5.setName("火热活动（测试中）");
        button1_5.setUrl(Application.domainNameWithProtocal + "/w/bargain");
		...
		button1.setName("虾迷福利");

		// 第二个按钮集合
		WxMenu.WxMenuButton button2 = new WxMenu.WxMenuButton();
		button2.setType("view");
		button2.setName("叫外卖啦");
		button2.setUrl("http://www.77wm.com.cn");

		// 第三个按钮集合
		WxMenu.WxMenuButton button3_1 = new WxMenu.WxMenuButton();
		button3_1.setType("view");
		button3_1.setName("关于珠海");
		button3_1.setUrl(
				"http://mp.weixin.qq.com/s?__biz=MzIxOTE0NDIzMA==&mid=404289264&idx=1&sn=fc7e48c70b7fb1b55fd8dc4aee28f3b5#rd");

		WxMenu.WxMenuButton button3_2 = new WxMenu.WxMenuButton();
		button3_2.setType("view");
		button3_2.setName("门店环境");
		button3_2.setUrl(
				"http://mp.weixin.qq.com/s?__biz=MzIxOTE0NDIzMA==&mid=405411609&idx=1&sn=d79d7deeba993abe2c90eedc88762e15#rd");

		WxMenu.WxMenuButton button3_3 = new WxMenu.WxMenuButton();
		button3_3.setType("view");
		button3_3.setName("门店导航");
		button3_3.setUrl(
				"http://mp.weixin.qq.com/s?__biz=MzIxOTE0NDIzMA==&mid=405416366&idx=1&sn=d87be8afc6726f25dc85d7b63f68bb00#rd");
